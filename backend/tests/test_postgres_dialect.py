...
class TestMigrations:
    ...
    def test_upgrade_head_builds_the_schema(self, postgres_engine, postgres_url):
    ...
    def test_letterhead_migration_round_trips(self, postgres_engine, postgres_url):
    ...
    def test_snapshots_are_really_jsonb(self, postgres_engine, postgres_url):
    ...
    def test_backfill_tolerates_an_empty_database(self, postgres_engine, postgres_url):
